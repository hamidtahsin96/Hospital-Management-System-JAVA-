...
public class ANurseDashboardFrame extends JFrame implements ActionListener
{
    ...
    private JLabel contactNoLabel, shiftLabel, departmentLabel;
    ...
    public ANurseDashboardFrame(User u)
    {
        ...
        this.departmentLabel.setBounds(50, 165, 100, 20);
        this.panel.add(departmentLabel);

        this.departmentTF = new JTextField();
        this.departmentTF.setBounds(150, 160, 180, 30);
        ...
        this.nurseTable = new JTable(data, column);

        this.nurseTableSP = new JScrollPane(nurseTable);
        this.nurseTableSP.setBounds(50, 270, 760, 300);
    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        else if(command.equals(editBtn.getText()))
        {
            if(!userIdTF.getText().isEmpty())
            {
                ...
                else
                {
                    ...
                    {
                        n.setContactNo(contactNoTF.getText());
                    }
        ...
        else if(command.equals(searchBtn.getText()))
        {
            if(!userIdTF.getText().isEmpty())
            {
                ...
                if(n != null)
                {
                    ...
                    contactNoTF.setText(n.getContactNo());
        ...
        else if(command.equals(viewAllBtn.getText()))
        {
            ...
            for(int i = 0; i < nurses.length; i++)
            {
                if(nurses[i] != null)
                {
                    data[i][0] = nurses[i].getUserId();
                    data[i][1] = nurses[i].getName();
                    data[i][2] = nurses[i].getEmail();
                    data[i][3] = nurses[i].getContactNo();
                    data[i][4] = nurses[i].getShift();
                    data[i][5] = nurses[i].getDepartment();
                }
            }
            ...
            this.panel.remove(nurseTableSP);
