...
public class DResetPasswordFrame extends JFrame implements ActionListener
{
    ...
    public DResetPasswordFrame(User u)
    {
    ...
    public void actionPerformed(ActionEvent ae)
    {
                ...
                if(u1 != null)
                {
                    ...
                    if(u1.getPassword().equals(currentPasswordValue))
                    {
                        if(retypeNewPasswordValue.equals(newPasswordValue))
                        {
                            ...
                            DoctorHomeFrame dhf = new DoctorHomeFrame(u1);
        ...
        {
            DoctorHomeFrame dhf = new DoctorHomeFrame(this.u1);
