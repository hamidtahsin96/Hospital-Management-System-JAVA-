...
public class RResetPasswordFrame extends JFrame implements ActionListener
{
    ...
    public RResetPasswordFrame(User u)
    {
        ...
        if(command.equals(changePasswordBtn.getText()))
        {
            ...
            else
            {
                ...
                if(user != null)
                {
                    ...
                    ReceptionistHomeFrame rhf = new ReceptionistHomeFrame(this.u1);
